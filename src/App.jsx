...
function App() {
  ...
  return (
    <>
      <NavBarContainer isClickOverflow={isClickOverflow} setIsClickOverflow={setIsClickOverflow} widthPage={widthPage}/>
      <Home/>
      <Footer/>
      ...
      <style>
        {`
          :root {
            overflow: ${widthPage<851  //Verificar si el ancho de la pagina es mayor o menor a 850
                          ?isClickOverflow ? "hidden" : "auto" // Si se hizo click en el menu el valor es hidden
